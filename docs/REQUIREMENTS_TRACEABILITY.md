...
| NXR-REQ-0016 | Financial statements (TB, GL, BS, P&L, Cash Flow) | ✅·➖·✅·✅·✅·✅·➖·✅·⬜ | IN_PROGRESS | Reconciliado 2026-08-25: esta fila describía en prosa el mismo alcance de estados financieros que terminó implementándose bajo `NXR-REQ-0093` (Reporting), no bajo un dueño "Track G" separado -- corrección de trazabilidad, no trabajo nuevo. Trial Balance, General Ledger (paginado), Balance Sheet e Income Statement (P&L) están reales -- ver la fila `NXR-REQ-0093` para la evidencia completa (`reporting_service.py`, tests, tabs de `/control/reportes`). Cash Flow es lo único de esta fila que sigue sin construir: no existe clasificación de actividad operativa/inversión/financiamiento persistida, y no se puede derivar honestamente del GL sin esa clasificación (ver diseño en `docs/superpowers/specs/2026-08-25-financial-statements-design.md`, sección "Explícitamente fuera de alcance") |
