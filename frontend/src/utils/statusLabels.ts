...
export const PROJECT_STATUS_LABELS: Record<string, string> = {
  PLANNING: 'Planificación', ACTIVE: 'Activo', ON_HOLD: 'Pausado', COMPLETED: 'Completado',
  CLOSED: 'Cerrado', CANCELLED: 'Cancelado', ARCHIVED: 'Archivado',
}

export const SUPPLIER_STATUS_LABELS: Record<string, string> = {
  ACTIVE: 'Activo', INACTIVE: 'Inactivo', BLOCKED: 'Bloqueado', ARCHIVED: 'Archivado',
}

export const SUPPLIER_PARTY_ROLE_LABELS: Record<string, string> = {
  SUPPLIER: 'Proveedor', CONTRACTOR: 'Contratista', BOTH: 'Proveedor y contratista',
}

export const SUPPLIER_CONTRACT_STATUS_LABELS: Record<string, string> = {
  DRAFT: 'Borrador', ACTIVE: 'Activo', COMPLETED: 'Completado', TERMINATED: 'Terminado anticipadamente',
}

export const CONTRACT_INSTALLMENT_STATUS_LABELS: Record<string, string> = {
  DUE: 'Por pagar', UPCOMING: 'Próxima', PARTIALLY_PAID: 'Parcialmente pagada',
  PAID: 'Pagada', OVERDUE: 'Vencida', CANCELLED: 'Cancelada',
}

export const CONTRACT_INSTALLMENT_KIND_LABELS: Record<string, string> = {
  ADVANCE: 'Anticipo', REGULAR: 'Mensualidad', RETENTION_RELEASE: 'Liberación de retención',
}
