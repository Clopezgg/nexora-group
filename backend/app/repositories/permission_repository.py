...
_BASE_PERMISSIONS: tuple[tuple[str, str, str], ...] = (
    ...
    ("procurement.supplier", "create", "Crear proveedores/contratistas"),
    ("procurement.supplier", "read", "Ver proveedores/contratistas"),
    ("procurement.supplier", "update", "Editar y cambiar estado de proveedores/contratistas"),
    ...
    ("contract.payment", "override", "Pagar un contrato con plan saltando la asignación a cuotas (excepción auditada)"),
    ...
    ("procurement.three_way_match", "override", "Autorizar una excepción de three-way match"),
...
_ROLE_GRANTS: dict[str, tuple[tuple[str, str, str], ...]] = {
    ...
    "Finance Manager": (
        ...
        ("contract.payment", "override", SCOPE_OWN),
    ...
    "Procurement Manager": (
        ...
        ("procurement.supplier", "read", SCOPE_OWN),
        ("procurement.supplier", "update", SCOPE_OWN),
        ...
        ("procurement.three_way_match", "override", SCOPE_OWN),
