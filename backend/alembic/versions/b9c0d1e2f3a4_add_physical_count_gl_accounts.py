...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        "fk_physical_counts_adjustment_gain_account", "physical_counts", "accounts",
        ["adjustment_gain_account_id"], ["id"], ondelete="RESTRICT",
    )
    op.create_foreign_key(
        "fk_physical_counts_adjustment_loss_account", "physical_counts", "accounts",
        ["adjustment_loss_account_id"], ["id"], ondelete="RESTRICT",
    )
