...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        'fk_companies_functional_currency_code', 'companies', 'currencies', ['functional_currency_code'], ['code']
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('fk_companies_functional_currency_code', 'companies', type_='foreignkey')
